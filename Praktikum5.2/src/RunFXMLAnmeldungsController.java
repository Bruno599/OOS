...
public class RunFXMLAnmeldungsController extends Application {
     ...
     * in Primaristage wird ein neuer Parent angelegt root mit dem design aus AnmeldungsController.fxml
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("prak4serv/AnmeldungsController.fxml"));
