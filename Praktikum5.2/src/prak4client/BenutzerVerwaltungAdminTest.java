...
public class BenutzerVerwaltungAdminTest { //extends TestCase{
    ...
    //private prak4client.BenutzerVerwaltungAdmin verwaltung2;
    ...
    /**
     * Testet was passiert wenn ein prak4gemklassen.Benutzer eingetragen werden soll udn die Datei nicht inizialisert wurde
     */
    @Test
    ...
    public void benutzerEintragen() {
        ...
        try{
            verwaltung.benutzerEintragen(new Benutzer("test", "123456".toCharArray()));
                ...
                | ClassNotFoundException | IOException | FalscherDateiNameExeption e){
            e.printStackTrace();
            Assert.fail("prak4gemklassen.Benutzer sollte angelegt werden können");
        }
    }

    /**
     * Testen des Falles, das ein leerer prak4gemklassen.Benutzer hinzugefügt werden soll
     */
    @Test
    public void benutzerEintragenLeer() {
        ...
        try{
            ...
            Assert.fail("prak4gemklassen.Benutzer kann nicht angelegt werden, ist leer");
        }
        catch(BenutzerExistiertBereitsExeption | BenutzerIDIstSchonVergebenExeption | BenutzerIstLeerExeption
                | ClassNotFoundException | IOException | FalscherDateiNameExeption e){
            e.printStackTrace();
    ...
    /**
     * Testen des Falles, das ein prak4gemklassen.Benutzer Doppelt hinzugefügt werden soll
     */
    @Test
    public void benutzerEintragenBenutzerDoppelt() {
        ...
        try{
            verwaltung.benutzerEintragen(new Benutzer("test", "123456".toCharArray()));
            verwaltung.benutzerEintragen(new Benutzer("test", "123456".toCharArray()));
            Assert.fail("prak4gemklassen.Benutzer sind doppelt");
        }catch(BenutzerExistiertBereitsExeption | BenutzerIDIstSchonVergebenExeption | BenutzerIstLeerExeption
                | ClassNotFoundException | IOException | FalscherDateiNameExeption e){
            e.printStackTrace();
    ...
    /**
     * Testen des Falles, das ein prak4gemklassen.Benutzer mit der einer schon vorhandenen ID eingetragen werden soll
     */
    @Test
    ...
    public void benutzerOk() {
        ...
        try{
            ...
            e.printStackTrace();
            Assert.fail("prak4gemklassen.Benutzer Vorhanden und korrekt");
        }
    }

    /**
     * Testen der Methode BenutzerOk wenn prak4gemklassen.Benutzer nicht vorhanden ist.
     */
    @Test
    ...
    public void benutzerLoeschen() {
        ...
        try{
            ...
            e.printStackTrace();
            Assert.fail("prak4gemklassen.Benutzer sollte gelöscht sein");
        }
    }

    /**
     * Testen der Methode prak4gemklassen.Benutzer löschen, wenn der prak4gemklassen.Benutzer nicht vorhanden ist
     */
    @Test
    ...
    public void benutzerLoeschenNichtVorhanden() {
        ...
        try{
            ...
            Assert.fail("prak4gemklassen.Benutzer sollte nicht vorhanden sein");
        }
        catch(ClassNotFoundException | IOException | BenutzerKonnteNIchtGeloeschtWerdenExeption
    ...
    public void printUsers() {
        ...
        try{
            ...
            e.printStackTrace();
            Assert.fail("prak4gemklassen.Benutzer in Datenstrucktur sollten asugegeben werden können");
        }
    }
    ...
    public void printUsersDateiNichtInizialisiert() {
        ...
        try{
            verwaltung.printUsers();
            Assert.fail("prak4gemklassen.Benutzer können nicht ausgegeben werden, da keine Datei inizialiesiert wurde");
        }
        catch(IOException | ClassNotFoundException e){
            e.printStackTrace();
        }
    ...
    public void searchUserID() {
        ...
        try{
            ...
            e.printStackTrace();
            Assert.fail("prak4gemklassen.Benutzer in Datenstrucktur sollten gefunden werden");
        }
    }
